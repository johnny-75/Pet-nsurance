        ...
        <div class="modal-dialog modal-lg shadow">
          <div class="modal-content">
            <div class="modal-header text-info">
                <h4 class="modal-title" id="myModalLabel">Due Payments</h4>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table">
                            ...
                            <tr class="text-dark">
                                ...
                                <th scope="row" style="font-weight: 600">Challan</th>
                            </tr>

                                <?php
                                    include "connect.php";
                                    $userid=$_SESSION['userid'];
                                    $query = "select * from insured_pet where userid=$userid and insured_status=0";
                                    ...
                                    if($result1->num_rows>0)
                                    {
                                        while($row=$result1->fetch_assoc())
                                        {
                                            ...
                                            <td class="align-middle"><a href="challan.php?insurance_id='.$insurance_id.'"><button type="button" class="btn btn-info btn-sm text-white">Print Challan</button></a></td>';
